...
<title>SMK Insan Aqilah 3 - Kata Sambutan</title>
<!-- Stylesheet -->
		...
		<!-- Content Seciton -->
        	<div id="content_section">
                ...
                <div class="staticblock2">
                    	<a href="#"><img  src="<?php echo base_url().'template/images/lead.jpeg'?>"  alt="" /></a>
                        <h4>Kata Sambutan Kepala Sekolah</h4><br/>
                        <p>Bismillahirohmannirrohim</p>

                        <p>Assalamualaikum Warahmatullah Wabarakatuh</p>

                        <p>Alhamdulillahi robbil alamin kami panjatkan kehadlirat Allah SWT, bahwasannya dengan rahmat dan karunia-Nya lah akhirnya Website sekolah ini dengan alamat smkinsanaqilah3.blogspot.com dapat kami perbaharui. Kami mengucapkan selamat datang di Website kami Sekolah Menengah Kejuruan (SMK) Insan Aqilah 3 Depok yang kami tujukan untuk seluruh unsur pimpinan, guru, karyawan dan siswa serta khalayak umum guna dapat mengakses seluruh informasi tentang segala profil, aktifitas/kegiatan serta fasilitas sekolah kami.</p>

                        <p>Saya selaku pimpinan sekolah mengucapkan terima kasih kepada tim pembuat Website ini yang telah berusaha untuk dapat lebih memperkenalkan segala perihal yang dimiliki oleh sekolah. Dan tentunya Website sekolah kami masih terdapat banyak kekurangan, oleh karena itu kepada seluruh civitas akademika dan masyarakat umum dapat memberikan saran dan kritik yang membangun demi kemajuan Website ini lebih lanjut.</p>
                        ...
                        <p>Terima kasih semoga Allah ‘Azza Wa Jalla menyertai doa kita semua. Amiin.</p>       
                    </div>
                </div>
